...
const FORM_STORAGE_KEY = "L7_OrderForm--2023-04-28"; // versioned to avoid errors w/ shape changes
...
const formatSizeChart = (sizeChart) => {
  ...
  if (Object.keys(overflow).length) {
    formattedSizeChart["Other"] = JSON.stringify(overflow, null, 2);
  }
...
const formatToParams = (formValues) => {
  const sharedFields = {
    ...
    attachments: formValues.attachments.length,
  };
