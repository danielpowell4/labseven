...
export async function getStaticPaths() {
  ...
  const paths = allProducts.map(product => ({ params: { id: product.ID.toString() }}));
    ...
    <Layout>
      ...
      <div>
        <ul>
          ...
          <li><strong>Supplier</strong> {productData.Supplier}</li>
          <li>
          ...
          <li>
            ...
            <ul>
              {productData.Categories.map(cat => <li key={cat.ID}>{cat.Name} ({cat.ID})</li>)}
            </ul>
          </li>
          <li>
